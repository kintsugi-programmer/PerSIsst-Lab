...
function Research() {
  return (
    <main className="relative w-full bg-gray-950 text-white">
      <section className="h-[20vh] bg-gray-950 "></section>
      <section className="w-full bg-gray-200 pb-6">
        <div className="mb-8">
        ...
        {/* Our Work Card */}
        <div className="w-full pb-2 md:balanced-width md:w-[840px] mx-auto rounded-xl overflow-hidden bg-slate-100 relative z-0 border-b-4 border-b-slate-300 border-t-2 border-r-2 border-r-slate-300 border-t-purple-500">
      ...
      <section className="w-full bg-gray-200">
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-10 sm:gap-8 items-center justify-center p-2 mb-10 w-full">
