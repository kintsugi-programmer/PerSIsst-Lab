...
function ContactUs() {
  return (
    <section className="w-full bg-gray-900">
      <div className='bg-gray-950 h-[25vh]'></div>
      <div className="mb-8">
      ...
      <div className="lg:max-w-[1280px] mx-auto grid place-items-center lg:grid-cols-2 bg-gray-900 p-6">
        
        <div className="flex flex-col justify-start gap-2 font-poppins text-left p-6">
          <div className="p-6">
        ...
        <div className="flex flex-col space-y-1">
          ...
          <div className="flex items-center gap-4 font-poppins p-4">
            <div className="w-20 h-20 flex items-center justify-center rounded-full bg-purple-500 text-white p-3">
          ...
          {/* Mail */}
          <div className="flex items-center gap-4 font-poppins p-4">
            <div className="w-20 h-20 flex items-center justify-center rounded-full bg-purple-500 text-white p-4">
      ...
      <div className='w-[1280px] lg:h-[300px] bg-gray-900 flex flex-col items-center justify-center mx-auto relative'>
          <img src="/assets/Maps.svg" alt="map iframe"  className='lg:w-[1000px] lg:h-[400px] absolute -bottom-[60%] z-30'/>
      </div>
      <div className="w-full lg:h-[250px] bg-gray-900 relative z-20 mx-auto overflow-hidden">
      <img
