      ...
      <div className='w-full h-auto bg-slate-900 relative'>
            <div className="absolute top-0 left-0 w-full h-full">
                ...
                <img
                    src="/bg/Vector.png"
                    alt="vector"
                    className=" absolute top-[25%] md:top-[20%] lg:top-[25%] left-[45vw] md:left-[40vw] lg:left-[50vw] transform -translate-x-1/2 -translate-y-1/2 z-20"
                />
            </div>
            <Purpose />
        </div>
...
const BG2 = () => {
  return (
    <>
      ...
      <p className="font-normal text-center md:text-lg  max-w-screen-lg mx-auto text-white">
