...
const Purpose = () => {
    return (
        <main className="min-h-screen bg-slate-950/[0.96] antialiased bg-grid-white/[0.02]  ">
            ...
            <div className='w-full h-[20vh] bg-slate-950'></div>
...
const OurPurpose = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <p className=" pt-3 font-normal text-white text-center md:text-lg  max-w-screen-lg mx-auto">
...
const OurPurposeCard = () => {
    return (
        ...
        <div className="py-5 flex flex-col lg:flex-row items-center justify-center  w-full gap-10 pb-40 mx-auto px-20">
