        ...
        <section>
            ...
            <div className="lg:max-w-[1280px] mx-auto  bg-gray-950 p-6">
                <div className="flex flex-col justify-center items-center gap-2 font-poppins text-left p-6">
                    ...
                    <div className="relative flex flex-col space-y-1 left-16 ">
                        ...
                        <div className="flex items-center gap-4 font-poppins p-4">
                            <div className="w-20 h-20 flex items-center justify-center rounded-full border-[5px] border-purple-600 text-white p-5">
                                <Image src="/assets/application-line.svg" alt="Map Icon" width={64} height={64} />
                            </div>
                            <div className="text-left">
                        ...
                        <div className="flex items-center gap-4 font-poppins p-4">
                            <div className="w-20 h-20 flex items-center justify-center rounded-full border-[5px] border-purple-600 text-white p-4">
                                <Image src="/assets/mail-line.svg" alt="Map Icon" width={64} height={64} />
                            </div>
                            <div className="text-left">
                        ...
                        <div className="flex items-center gap-4 font-poppins p-4">
                            <div className="w-20 h-20 flex items-center justify-center rounded-full border-[5px] border-purple-600 text-white p-5">
                                <Image src="/assets/wait.svg" alt="Map Icon" width={64} height={64} />
                            </div>
                            <div className="text-left">
