...
function EventSlider({ events }: EventSliderProps) {
  ...
  return (
    <div aria-label='Event Carousel' className="w-[80vw] h-[65vh] relative shadow-[2px_-20px_20px_10px_rgba(0,0,0,0.2)]">
      {/* This Div is for Card */}
      <div className="w-full h-[95%] flex overflow-hidden">
